---
title: Version Update 2.5.907
date: 2025-11-27
tags: ["#version update"]
---
**[fix]** Error message appeared when attempting to open perspective as a component in the Matlab editor. Now this is more gracefully handled with dialog.
**[fix]** Bug due to deprecated size method behaviour in 2025 Matlab version.
...
[Evaluation (x64)](/downloads/HIP-HOPS_Evaluation_(x64)_v2.5.907_setup.exe)	- This is a fully featured evaluation version for 64 bit Windows systems. It is limited to 20 components.  
[Commercial (x64)](/downloads/HIP-HOPS_Commercial_(x64)_v2.5.907_setup.exe)	- This is the full commercial version for 64 bit Windows systems. It requires a hardware license key to run.  
[SimulationX (x64)](/downloads/SimX_HiP-HOPS_x64_v2.5.907.zip) - This is the ITI SimulationX compatible version for 64 bit Windows systems. It requires a hardware license key to run.  
