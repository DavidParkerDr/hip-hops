---
title: Version Update 2.5.906
date: 2025-05-02
tags: ["#version update"]
---
**[fix]** In Chrome based browsers there was a bug that prevented the treeview from operating properly when you returned to the treeview having navigated somewhere else.
...
[Evaluation (x64)](/downloads/HIP-HOPS_Evaluation_(x64)_v2.5.906_setup.exe)	- This is a fully featured evaluation version for 64 bit Windows systems. It is limited to 20 components.  
[Commercial (x64)](/downloads/HIP-HOPS_Commercial_(x64)_v2.5.906_setup.exe)	- This is the full commercial version for 64 bit Windows systems. It requires a hardware license key to run.  
[SimulationX (x64)](/downloads/SimX_HiP-HOPS_x64_v2.5.906.zip) - This is the ITI SimulationX compatible version for 64 bit Windows systems. It requires a hardware license key to run.  
